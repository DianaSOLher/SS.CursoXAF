...
namespace CursoXAF.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            Pais idiomas = ObjectSpace.FirstOrDefault<Pais>(u => u.Nombre == "USA");
            if (idiomas == null)
            {
                idiomas = ObjectSpace.CreateObject<Pais>();
                idiomas.Nombre = "USA";
                idiomas.Visible = false;
                idiomas.FechaCreacion = DateTime.Now;
                idiomas.Save();
            ...
            {
                Catalogo_Idioma idiomasAcrear = ObjectSpace.FirstOrDefault<Catalogo_Idioma>(u => u.Nombre == cadaIdioma);
                if (idiomasAcrear == null)
                {
                    idiomasAcrear = ObjectSpace.CreateObject<Catalogo_Idioma>();
                    idiomasAcrear.Nombre = cadaIdioma;
                    idiomasAcrear.Visible = false;
                    idiomasAcrear.Save();
